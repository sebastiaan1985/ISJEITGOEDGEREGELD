export const TIPS: Record<string, string> = {
  ...
  "1.8": "Vaste hardware-vervangingscyclus (4–5 jaar) voorkomt verouderde apparaten en hoge storingskansen.",
  "2.8": "Back-up hersteltest: minimaal jaarlijks oefenen zodat je zeker weet dat je data terugkrijgt.",
  "3.8": "Continue netwerkmonitoring met automatische alerting — problemen oplossen vóórdat medewerkers er last van hebben.",
  "4.8": "Leveranciersregister met SLA's en verloopdatums — grip op contracten voorkomt verrassingen.",
...
export const INSIGHTS: Record<string, string> = {
  ...
  "1.8": "Laptops ouder dan 5 jaar zijn 3× vaker defect en 40% langzamer dan moderne apparatuur — de productiviteitskosten overstijgen vaak de vervangingskosten.",
  "2.8": "60% van bedrijven die ransomware-herstel testen, ontdekt dat minimaal één back-up niet werkt zoals verwacht. Testen is geen luxe.",
  "3.8": "Gemiddeld duurt het 4,5 uur voordat een ongemonitord netwerk een storing detecteert. Met monitoring is dat minder dan 10 minuten.",
  "4.8": "MKB-bedrijven hebben gemiddeld 12–18 actieve IT-leveranciers waarvan 30% contracten heeft die al verlopen zijn zonder dat men het weet.",
